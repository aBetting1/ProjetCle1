...
public class Cle {
    ...
    public void Supprimer(int num){
        ...
        try {
            ...
            PreparedStatement req = connexion.prepareStatement("DELETE FROM Cle WHERE num = ?");
            req.setInt(1, num);
            req.execute();
    ...
    public ResultSet Modifier(int num,int numero,String couleur, String ouverture) {
        ...
        try {
            ...
            PreparedStatement req1 = connexion.prepareStatement("UPDATE Cle SET Numero = ?, couleur = ?, Ouverture = ? WHERE Numero = num;");
            req1.setString(1, couleur);
            req1.setString(2, ouverture);
            req1.setString(3, ouverture);
            req1.execute();
